...
class Person1{
  ...
  describe(){
    console.log(`On ${this.date}, ${this.firstname} ${this.lastname} was the first person to set foot on the Earth's moon.`)
  }
}
let person1 = new Person1(`Neil`, `Armstrong`, `July 20th 1969`, );
person1.describe();
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting(`Kaleb`, `AR`);
myGreeting.hello();
/*-------------------------------------------------------*/
// Question 3: myBook
console.log(`--------------------------
...
class Fruit{
  ...
  describe(){
    console.log(`${this.name} is ${this.color} and has a ${this.taste} taste.`)
  }
}
...
class List{
  ...
  displayMovies(){
    for(let i = 0; i < this.movies.length; i++){
      console.log(this.movies[i].describe());
    }
  }
}
...
list.displayMovies[movie1, movie2]
